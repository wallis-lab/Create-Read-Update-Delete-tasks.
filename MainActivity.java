    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Boolean checkinsertdate= DB.insertuserdata(nameTxt,contactTxt, dobTXT);
                if (checkinsertdate==true)
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Boolean checkupdatedate= DB.insertuserdata(nameTxt,contactTxt, dobTXT);
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Boolean checkdeletedate= DB.insertuserdata(nameTxt,contactTxt, dobTXT);
                if (checkdeletedate==true)
